...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIDocumentInteractionControllerDelegate, UIAlertViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func sendLinkFeed() -> Void {
        ...
        let template = KLKFeedTemplate.init { (feedTemplateBuilder) in
            ...
            feedTemplateBuilder.content = KLKContentObject.init(builderBlock: { (contentBuilder) in
                ...
                contentBuilder.imageURL = URL.init(string: "http://mud-kage.kakao.co.kr/dn/Q2iNx/btqgeRgV54P/VLdBs9cvyn8BJXB3o7N8UK/kakaolink40_original.png")!
    ...
    func sendLinkList() -> Void {
        ...
        // List 타입 템플릿 오브젝트 생성
        let template = KLKListTemplate.init { (listTemplateBuilder) in
            
            // 헤더 타이틀 및 링크
            listTemplateBuilder.headerTitle = "WEEKLY MAGAZINE"
            listTemplateBuilder.headerLink = KLKLinkObject.init(builderBlock: { (linkBuilder) in
                linkBuilder.mobileWebURL = URL.init(string: "https://developers.kakao.com")
            })
            
            // 컨텐츠 목록
            listTemplateBuilder.addContent(KLKContentObject.init(builderBlock: { (contentBuilder) in
                contentBuilder.title = "취미의 특징, 탁구"
                contentBuilder.desc = "스포츠"
                contentBuilder.imageURL = URL.init(string: "http://mud-kage.kakao.co.kr/dn/bDPMIb/btqgeoTRQvd/49BuF1gNo6UXkdbKecx600/kakaolink40_original.png")!
                contentBuilder.link = KLKLinkObject.init(builderBlock: { (linkBuilder) in
                    linkBuilder.mobileWebURL = URL.init(string: "https://developers.kakao.com")
                })
            }))
            listTemplateBuilder.addContent(KLKContentObject.init(builderBlock: { (contentBuilder) in
                ...
                contentBuilder.imageURL = URL.init(string: "http://mud-kage.kakao.co.kr/dn/QPeNt/btqgeSfSsCR/0QJIRuWTtkg4cYc57n8H80/kakaolink40_original.png")!
                contentBuilder.link = KLKLinkObject.init(builderBlock: { (linkBuilder) in
                    linkBuilder.mobileWebURL = URL.init(string: "https://developers.kakao.com")
                })
            }))
            listTemplateBuilder.addContent(KLKContentObject.init(builderBlock: { (contentBuilder) in
                ...
                contentBuilder.imageURL = URL.init(string: "http://mud-kage.kakao.co.kr/dn/c7MBX4/btqgeRgWhBy/ZMLnndJFAqyUAnqu4sQHS0/kakaolink40_original.png")!
                contentBuilder.link = KLKLinkObject.init(builderBlock: { (linkBuilder) in
                    linkBuilder.mobileWebURL = URL.init(string: "https://developers.kakao.com")
                })
            }))
            ...
            // 버튼
            listTemplateBuilder.addButton(KLKButtonObject.init(builderBlock: { (buttonBuilder) in
                buttonBuilder.title = "웹으로 보기"
                buttonBuilder.link = KLKLinkObject.init(builderBlock: { (linkBuilder) in
                    linkBuilder.mobileWebURL = URL.init(string: "https://developers.kakao.com")
                })
    ...
    func sendLinkCommerce() -> Void {
        ...
        let template = KLKCommerceTemplate.init { (commerceTemplateBuilder) in
            
            // 컨텐츠
            commerceTemplateBuilder.content = KLKContentObject.init(builderBlock: { (contentBuilder) in
                contentBuilder.title = "신메뉴 출시❤️ 체리블라썸라떼"
                contentBuilder.imageURL = URL.init(string: "http://mud-kage.kakao.co.kr/dn/bSbH9w/btqgegaEDfW/vD9KKV0hEintg6bZT4v4WK/kakaolink40_original.png")!
                contentBuilder.link = KLKLinkObject.init(builderBlock: { (linkBuilder) in
                    linkBuilder.mobileWebURL = URL.init(string: "https://developers.kakao.com")
            ...
            // 가격
            commerceTemplateBuilder.commerce = KLKCommerceObject.init(builderBlock: { (commerceBuilder) in
                commerceBuilder.regularPrice = 12345
                commerceBuilder.discountRate = 20
                commerceBuilder.discountPrice = 10000
            })
        }
    ...
    func sendLinkScrap() -> Void {
        ...
        // 스크랩할 웹페이지 URL
        let url = URL.init(string: "https://store.kakaofriends.com/")!
    ...
    func scrapRemoteImage() -> Void {
        ...
        // 원격지 이미지 URL
        let imageURL = URL.init(string: "http://www.kakaocorp.com/images/logo/og_daumkakao_151001.png")!
